...
export default function TglTransportLanding() {
    ...
    <div className="min-h-screen bg-white text-slate-800">
      ...
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur border-b">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium">
            ...
            <a href="#packages" className="hover:text-blue-600">Gói vận chuyển</a>
            <a href="#pricing" className="hover:text-blue-600">Bảng giá</a>
            <a href="#news" className="hover:text-blue-600">Tin tức</a>
            <a href="#careers" className="hover:text-blue-600">Tuyển dụng</a>
            <a href="#contact" className="hover:text-blue-600">Liên hệ</a>
          </nav>
          <a href="https://www.facebook.com/tgltrans/" className="inline-flex items-center rounded-full px-4 py-2 bg-blue-600 text-white text-sm font-semibold shadow hover:bg-blue-700">Nhận tư vấn</a>
        </div>
      </header>
      ...
      <section className="relative">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?q=80&w=1976&auto=format&fit=crop" alt="Port" className="h-full w-full object-cover"/>
          <div className="absolute inset-0 bg-slate-900/60"/>
        </div>
        <div className="relative max-w-7xl mx-auto px-4 py-24 md:py-32 text-white">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-6xl font-black leading-tight drop-shadow-lg">TGL TRANSPORT
              <span className="block text-blue-300">Logistics Solutions</span>
            </h1>
            <p className="mt-6 text-lg md:text-xl opacity-90">Dịch vụ vận chuyển quốc tế chuyên nghiệp – Door to Door, thông quan, theo dõi đơn đến tay người nhận. 220+ quốc gia, 5+ năm kinh nghiệm.</p>
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <a href="#contact" className="inline-flex items-center justify-center rounded-xl px-5 py-3 bg-blue-600 font-semibold shadow hover:bg-blue-700">Nhận báo giá nhanh</a>
              <a href="#track" className="inline-flex items-center justify-center rounded-xl px-5 py-3 bg-white/10 ring-1 ring-white/30 hover:bg-white/20">Tra cứu vận đơn</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="track" className="-mt-10 relative z-10">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-6">
          ...
          <div
  id="quote" className="rounded-2xl shadow-xl p-6 text-white bg-gradient-to-br from-indigo-800 to-slate-900">
  ...
  <div className="mt-4 grid sm:grid-cols-2 gap-3">
    <input
      className="rounded-xl px-4 py-3 bg-white text-slate-900
                 placeholder:text-slate-500 shadow
                 ring-1 ring-white/20 focus:ring-2 focus:ring-white
                 outline-none"
      placeholder="Tuyến (Mỹ/Úc/Âu…)"
    />
    <input
      className="rounded-xl px-4 py-3 bg-white text-slate-900
                 placeholder:text-slate-500 shadow
    ...
    <input
      className="rounded-xl px-4 py-3 bg-white text-slate-900
                 ...
                 ring-1 ring-white/20 focus:ring-2 focus:ring-white
                 outline-none"
      placeholder="Dịch vụ (Door to Door, Express…)"
    />
    <input
      className="rounded-xl px-4 py-3 bg-white text-slate-900
                 placeholder:text-slate-500 shadow
  ...
  <button className="mt-4 rounded-xl px-5 py-3 bg-white text-slate-900 font-semibold hover:bg-slate-100">
    <a
...
>
  Gửi yêu cầu
      ...
      <section id="packages" className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-6">
            {[
                { img: "/images/Australia.jfif", title: "Vận chuyển hàng đi Úc" },
      ...
      {/* Partners carousel (simple marquee style) */}
  ...
  <div className="max-w-7xl mx-auto px-4">
    ...
    <div className="mt-6 overflow-hidden">
      {(() => {
        ...
        // nhân đôi để slide liên tục mượt hơn
      ...
      <section id="about" className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-10 items-center">
          <div className="rounded-2xl overflow-hidden shadow">
            <img src="/images/gt.jpg" alt="Air logistics" className="w-full h-full object-cover" />
          </div>
          <div>
            <h2 className="text-2xl md:text-3xl font-extrabold">Giới thiệu về TGL TRANSPORT</h2>
            <p className="mt-4 text-slate-700 leading-relaxed"> CÔNG TY TNHH TGL TRANSPORT được thành lập vào năm 2021 với sứ mệnh cung cấp các dịch vụ vận chuyển quốc tế chuyên nghiệp, nhanh chóng và an toàn cho khách hàng cá nhân và doanh nghiệp.Với địa chỉ tại <strong>55 Trương Quốc Dung, Phường Phú Nhuận, TP. Hồ Chí Minh</strong>. Chúng tôi am hiểu sâu sắc các quy trình logistics, thủ tục hải quan quốc tế và luôn cập nhật kịp thời các quy định liên quan, nhằm đảm bảo mỗi lô hàng đều được xử lý chính xác và vận chuyển đến tay người nhận một cách hiệu quả nhất.</p>
  ...
  <div className="max-w-7xl mx-auto px-4 py-3 text-center text-slate-100 text-sm">
    ...
    {" "}Design by  <a href="https://www.facebook.com/thedien710"   target="_blank"rel="noopener noreferrer"className="font-bold hover:underline underline-offset-4"aria-label="Mở Facebook của theneid"
    >
      theneid
    </a>
    {" "}|{" "}
    <a href="/sitemap.xml" className="hover:underline underline-offset-4">Sitemaps</a>
  </div>
</div>
      </footer>
    </div>
